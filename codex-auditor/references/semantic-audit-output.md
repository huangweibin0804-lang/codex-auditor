...
- `progress`: require an earlier and later evidence ID for the same behavior dimension. The evidence timestamps must differ by at least the greater of 24 hours or 20% of the audit range. If the condition is not met, omit progress.
